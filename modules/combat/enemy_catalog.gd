...
const DEFINITIONS := {
	...
	"bomber": {"model": "bomber", "type": "soldier", "hp": 72.0, "speed": 3.85, "damage": 46.0, "radius": SOLDIER_RADIUS, "preferred": 3.4, "range": 3.4, "interval": 0.0, "incoming": 0.72,
		"behavior": {"retreat": false, "detonation": {"range": 3.4, "effect_radius": 5.2, "jammed": false}}},
	"shooter": {"model": "drone", "type": "drone", "hp": 48.0, "speed": 4.5, "damage": 7.0, "radius": 0.95 * WorldScale.DRONE_SCALE, "preferred": 24.0, "range": 46.0, "interval": 0.78, "height": 4.8,
		"behavior": {"flight": {"turn_rate": 2.6, "strafe": 0.65, "near_throttle": -0.55, "hold_throttle": 0.08, "altitude_bob": 0.22},
			"evasion": {"chance": 0.3, "cooldown": 0.95, "reaction": 0.32, "duration": 0.21, "minimum_radius": 1.6, "padding": 0.55, "strength": 1.05, "urgency_strength": 0.45}}},
	"kamikaze": {"model": "kamikaze", "type": "drone", "hp": 38.0, "speed": 6.4, "damage": 38.0, "radius": 1.05 * WorldScale.DRONE_SCALE, "preferred": 0.0, "range": 4.2, "interval": 0.0, "height": 3.6, "salvage_drops": 2,
		"behavior": {"flight": {"turn_rate": 3.4, "strafe": 0.0, "near_throttle": -0.55, "hold_throttle": 0.08, "altitude_bob": 0.12, "always_advance": true},
			"evasion": {"chance": 0.18, "cooldown": 1.2, "reaction": 0.24, "duration": 0.16, "minimum_radius": 1.5, "padding": 0.45, "strength": 0.72, "urgency_strength": 0.3},
			"detonation": {"range": 4.2, "effect_radius": 0.0, "jammed": true}}},
	...
	"repairCrawler": {"model": "repairCrawler", "type": "priorityVehicle", "hp": 185.0, "speed": 2.75, "damage": 0.0, "radius": 2.65, "preferred": 31.0, "range": 0.0, "interval": 0.00, "priority": 2,
		"behavior": {"repair": {"stop_range": 9.0, "turn_rate": 1.25, "recheck": 0.25, "range": 36.0, "heal_rate": 12.0, "tick_cap": 0.25, "pulse_interval": 0.85}}},
